...
public class Datum {
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((this.refVehicle == rhs.refVehicle)||((this.refVehicle!= null)&&this.refVehicle.equals(rhs.refVehicle)))&&((this.fuelLevel == rhs.fuelLevel)||((this.fuelLevel!= null)&&this.fuelLevel.equals(rhs.fuelLevel))))&&((this.timeInstant == rhs.timeInstant)||((this.timeInstant!= null)&&this.timeInstant.equals(rhs.timeInstant))))&&((this.location == rhs.location)||((this.location!= null)&&this.location.equals(rhs.location))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.speed == rhs.speed)||((this.speed!= null)&&this.speed.equals(rhs.speed))));
    }
